...
int main () {
    ...
    do {
        ...
        switch (start) {   //on pose 3 cas differents selon le choix de l'utilisateur
            ...
            default: { //si l'utilisateur souhaite quitter
                return 0;
            }
        ...
        do {
            ...
            if (ia % 2 == 1){   //meme chose si il n'y a qu'un joueur et une IA
                ...
                switch (option_choice(g1)) {    //avec la fonction otion_choice le joueur don c'est le tour choisi entre ajouter un jeton, en retirer un ou sauvegarder et quitter
                    ...
                    case 3: //si l'utilisateur choisit de sauvegarder et quitter
            ...
            show_grid(g1);  //on affiche la grille pour que le joueur voit ou il en est
